...
<?php if ( isset( $churches ) ) : ?>
	...
	<div class="gamos-profile-filter">
		...
		<form id="gamos-profile-filter-form" method="get" action="<?php echo site_url( 'profile-list' ); ?>">
			...
			<table>
				...
				<tr>
					...
					<td>
						<select name="profile_education" id="profile_education" class="gamos-select2">
							...
							<option value="diploma" <?php selected( $education, 'diploma' ); ?>><?php esc_html_e( 'Diploma', 'gamos-plugin' ); ?></option>
				...
				<tr>
					...
					<th>
						<label for="profile_gender" class="filter-item-label"><?php esc_html_e( 'Gender', 'gamos-plugin' ); ?></label>
					</th>
					<td>
