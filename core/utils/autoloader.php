...
// Only if required.
if ( ! function_exists( 'gamos_auto_loader' ) ) {
	/**
	 * Dynamically loads the class attempting to be instantiated elsewhere in the
	 * plugin by looking at the $class_name parameter being passed as an argument.
	 *
	 * The argument should be in the form: Gamos\Namespace. The
	 ...
	 * @since 1.0.0
	 */
	function gamos_auto_loader( $class_name ) {
		// If the specified $class_name does not include our namespace, duck out.
		if ( false === strpos( $class_name, 'Gamos' ) ) {
			return;
		}
 ...
 */
spl_autoload_register( 'gamos_auto_loader' );